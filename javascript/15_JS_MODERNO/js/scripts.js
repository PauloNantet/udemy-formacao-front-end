...
const users = [
  ...
  { nome: "Maria", available: true },
  { nome: "Josias", available: false },
  { nome: "Kleber", available: true },
];
...
console.log(`O nomme do usuário é ${userName} e ele tem ${age} anos`);
