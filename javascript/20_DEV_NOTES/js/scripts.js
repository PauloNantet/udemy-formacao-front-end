...
function generatedId() {
  return Math.floor(Math.random() * 5000); // Arredondar um númeto aleatório de 0 à 5000
}
...
// Local storage
function getNotes() {
  const notes = JSON.parse(localStorage.getItem("notes") || "[]"); // E se for false, vai retornar um array vazio sem erros
